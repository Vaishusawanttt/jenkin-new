pipeline {
    ...
    stages {
        ...
        stage('Test') {
            steps {
                sh '/opt/apache-maven-3.9.6/bin/mvn sonar:sonar -Dsonar.projectKey=studentapp-ui -Dsonar.host.url=http://18.204.15.149:9000 -Dsonar.login=5a3b6333454730651ceb5682d2ab4566e5e41b2a'
